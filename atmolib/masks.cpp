...
void
Mask::Tab::drawTab(const TabStyle s, const TabPos pos, QRect r, QPainter *p, const QWidget *w, QBrush b, const QStyleOptionTab *opt, const quint8 hover, const bool inUno)
{
    if (!opt)
        return;

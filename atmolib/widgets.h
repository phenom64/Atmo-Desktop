...
// NSE-prefixed aliases for UI elements (public API convenience)
namespace NSE {
    using NSEButtonBase = ButtonBase;
    using NSEButtonGroupBase = ButtonGroupBase;
    using NSEWidgetButton = WidgetButton;
    using NSESplitterExt = SplitterExt;
}

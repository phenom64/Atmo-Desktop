...
public:
    ...
    bool drawRubberBand(const QStyleOption *option, QPainter *painter, const QWidget *widget = 0) const;
...
#undef TESTOPT
    ...
    static bool isVertical(const QStyleOptionTab *tab = 0, const QTabBar *tabBar = 0);
...
class AtmoStylePlugin : public QStylePlugin
{
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID QStyleFactoryInterface_iid FILE "atmo.json")
#endif
public:

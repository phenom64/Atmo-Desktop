...
//    qDebug() << "DSP::TitleWidget::toolBarOrientationChagned";
...
{
    QToolBar *toolBar = static_cast<QToolBar *>(sender());
//    qDebug() << "DSP::TitleWidget::toolBarFloatingChagned" << floating;
    if (floating)
        unembedLater();
    ToolbarHelpers::adjustMarginsLater(toolBar);
}
...
{
    QToolBar *toolBar = static_cast<QToolBar *>(sender());
//    qDebug() << "DSP::TitleWidget::toolBarMovableChanged" << movable;
    if (!movable)
        unembedLater();
    else
        embedLater();
...
{
//    QToolBar *toolBar = static_cast<QToolBar *>(sender());
//    qDebug() << "DSP::TitleWidget::toolBarVisibilityChanged";
    if (!m_logicalQueued)
    {
...
{
//    qDebug() << "DSP::TitleWidget::logicalToggle()" << m_toolBar->isVisible() << shouldEmbed();
    m_logicalQueued = false;
    if (shouldEmbed())
        embedLater();
    else
...
//    qDebug() << "DSP::TitleWidget::unembed" << win;
    if (!win)
    {
        deleteLater();
        return;

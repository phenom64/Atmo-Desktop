...
MenuBar::MenuBar(Deco *deco, const QString &service, const QString &path)
    : KDecoration3::DecorationButtonGroup(deco)
    , deco(deco)
...
MenuBar::paint(QPainter *painter, const AtmoDecoRect &repaintArea)
{
    ...
    KDecoration3::DecorationButtonGroup::paint(painter, repaintArea);
}
...
MenuBarItem::MenuBarItem(MenuBar *menu, int index)
    : KDecoration3::DecorationButton(KDecoration3::DecorationButtonType::Custom, menu->deco, menu->deco)
    , m(menu)
    , hasGeo(false)
    , idx(index)
{
